...
procedure ActivityLog:
    ...
    do for BufActivityLog transaction:
        ...
        assign
            ...
            BufActivityLog.Detail3       = "Number of HH Features to Update: " + string(numHHFeaturesUpdated)
            bufActivityLog.Detail4       = "Number of HH Feecodes to Update: " + string(numRecs)
            bufActivityLog.Detail5       = "Number of HH Answers to Update: " + string(numAnswersFixed).
    end.
end procedure.