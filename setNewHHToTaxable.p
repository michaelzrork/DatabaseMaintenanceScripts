/*------------------------------------------------------------------------
    File        : setNewHHToTaxable.p
    Purpose     : 

    Syntax      : 

    Description : Sets all new households created since 11/06/2024 to Taxable
...
do ixLog = 1 to inpfile-num:
    if search(sessiontemp() + "setNewHHToTaxableLog" + "_" + replace(string(logfileDate),"/","-") + "_" + string(logfileTime) + "_" + string(ixLog) + ".csv") <> ? then 
        SaveFileToDocuments(sessiontemp() + "setNewHHToTaxableLog" + "_" + replace(string(logfileDate),"/","-") + "_" + string(logfileTime) + "_" + string(ixLog) + ".csv", "\Reports\", "", no, yes, yes, "Report").  
end.
...
procedure put-stream:
    ...
    inpfile-loc = sessiontemp() + "setNewHHToTaxableLog" + "_" + replace(string(logfileDate),"/","-") + "_" + string(logfileTime) + "_" + string(inpfile-num) + ".csv".
...
procedure ActivityLog:
    ...
    do for BufActivityLog transaction:
        ...
        assign
            BufActivityLog.SourceProgram = "setNewHHToTaxable.r"
