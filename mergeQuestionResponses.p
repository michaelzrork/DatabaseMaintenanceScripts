...
assign
    ...
    isDuplicate           = false
    origQuestionLinkID    = 21196180 // CLONE ID OF ORIGINAL QUESTION
    dupQuestionID         = 4338311 // QUESTION & ANSWERS TO MERGE OR DELETE 
    newQuestionID         = 24153758. // QUESTION TO MERGE INTO
...
procedure ActivityLog:
    ...
    do for BufActivityLog transaction:
        ...
        assign
            BufActivityLog.SourceProgram = "mergeSAAnswers.r"
