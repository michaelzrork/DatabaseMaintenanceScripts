...
define variable answerList as character no-undo.
assign
    numAnswers   = 0
    //numQuestions = 0
    questionID   = 89291881.
    answerList = "Black,Asian,Caucasian,Native American,Pacific Island Alaskan".

/*************************************************************************
                                MAIN BLOCK
*************************************************************************/

for each QuestionResponse no-lock where QuestionResponse.QuestionLinkID = questionID and lookup(QuestionResponse.Answer,answerList) > 0.
